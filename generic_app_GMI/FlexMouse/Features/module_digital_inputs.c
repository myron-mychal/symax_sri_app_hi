...
void InitDigtialInputSetting(void){   
  ...
  digitalInputs_Control.digitalInputs_Setting.debounceCountLimit_u8 = 4; // # of counts digital input should be active high/low to consider it as active high/low
  digitalInputs_Control.digitalInputs_Setting.inputPolarity_u16 = 0x0;   // Each bit indicates the polarity of the input. 0= Normally Open, 1 = Normally closed. Bit 0 = Digital input 0 polarity.
  ...
  digitalInputs_Control.digitalInputs_Data.is_invertDirection = FALSE;
  ...
  {
    digitalInputs_Control.digitalInputs_Data.is_motorEnabled = FALSE;
  } else {
    digitalInputs_Control.digitalInputs_Data.is_motorEnabled = TRUE;
  }
...
void ProcessDigitalInputs(uint8_t input_no_u8, uint8_t state_value_u8){
  ...
  uint8_t input_function_u8;
  
  input_function_u8 = digitalInputs_Control.digitalInputs_Setting.inputFunction[input_no_u8];
  
  switch(input_function_u8){
  case MOTOR_ENABLE:    // 0
    digitalInputs_Control.digitalInputs_Data.digitalInputsValue[input_no_u8] = state_value_u8;
    digitalInputs_Control.digitalInputs_Data.is_motorEnabled = state_value_u8;
    break;
  ...
  case SET_DIRECTION:   // 2
    digitalInputs_Control.digitalInputs_Data.digitalInputsValue[input_no_u8] = state_value_u8;
    digitalInputs_Control.digitalInputs_Data.is_invertDirection = state_value_u8;
    break;
...
uint8_t GetDebouncedValue(uint8_t input_no_u8, uint8_t current_value_u8){
  ...
  if(previous_input_state_u8[input_no_u8] != current_value_u8) // Input state changed.
  {
    ...
    if(debouce_count_u8[input_no_u8] >= digitalInputs_Control.digitalInputs_Setting.debounceCountLimit_u8)
