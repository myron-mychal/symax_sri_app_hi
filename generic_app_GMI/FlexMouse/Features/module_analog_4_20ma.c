...
uint8_t analog_amps_increasing_debounce_count_u8 = 0; // Count to check if analog volts is above debounce value
uint8_t analog_amps_decreasing_debounce_count_u8 = 0; // Count to check if analog volts is below debounce value
uint16_t analog_amps_counts_u16 = 0;         // Temporary storage for ADC value
uint8_t analog_amps_low_alarm_enable_count_u8 = 0;    // Time when analog module init is complete
                            ...
                            uint8_t irq_identifier_u8)
{
  ...
  case INIT_MODULE:
    {     
      ...
      analog_amps_low_alarm_enable_count_u8 = analog_4_20ma_Control_ptr.analog_4_20mA_Setting.analogLowAlarmEnableCount_u8; // delay before analog low voltage alarm can be triggered
  ...
  case RUN_MODULE:                                                             
    {      
      ...
      if (getSysCount() >= module_analog_4_20ma_poll_time_u64) 
      {
        ...
        if(analog_amps_low_alarm_enable_count_u8 > 0){
          analog_amps_low_alarm_enable_count_u8--;
        }      
        ...
        analog_4_20ma_Control_ptr.analog_4_20mA_Data.analogErrorCode_u8 = (*adc1_LocalAnalogAmpsControl_ptr).adc1_ResultAvg.errorCode_u8; // Get any error codes
        ...
        if ((analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_analogLow == TRUE) && (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_analogLowEnable == TRUE) && (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_analogFailSafeEnable == FALSE))
        {
          ...
          analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_lowerHysteresisEnable = FALSE;
          analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_upperHysteresisEnable = FALSE;
...
*/
void Init_Analog_4_20mA_Setting(void){  
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.onVolts_u16 = 205;             // Demand turn ON volts in counts of ADC
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.offVolts_u16 = 164;            // Demand turn OFF volts in counts of ADC. Acts as Hysteresis
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.minVolts_u16 = 500;            // Min volts correspodning to min demand
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.maxVolts_u16 = 3800;           // Max volts corresponding to max demand  
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.maxAdcCounts_u16 = 4095;       // Max output of ADC. 12 bit ADC left sifted by 4
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.debounceThresholdCounts_u16 = 41;    // Change demand if the change in analog is outside this threshold. In ADC counts
  ...
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.voltsHysteresis_u16 = 41 ;     // Hys volts at the top end of demand. In ADC counts
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.minDemand_u16 = 13107;         // Min allowed demand. 20%
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.maxDemand_u16 = 0xFFFF;        // Maximum allowed demand
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.minDemandHysteresis_u16 = 500; // Lower end hysteresis if Min_Demand > Off_Volts demand. Counts 
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.analogLowVolts_u16 = 820;     // Volts below which the bAnalog_Loss_Enable is set. In ADC counts
  ...
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.analogLowAlarmEnableCount_u8 = 100;  // analogPeriod*count delay before analog low volts alarm is detected in mSec. 
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.debounceLoopCount_u8 = 4;            // Debounce count
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.analogGain_f = 0.08056640625;            // Convert ADC coutns to volts 3.3/4096*100
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.analogVoltsToAmpsGain_f = 6.329114; // Convert analog volts to mAmps 1000*1/158ohms
  
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_enableAnalog = TRUE;          // If set to "0", 0V = Max demand 10V= 0 Demand
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_invertAnalog = FALSE;         // If set to "0", 0V = Max demand 10V= 0 Demand
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_analogLowEnable = TRUE;       // Enable analog low detect if set to "1"
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_analogFailSafeEnable = FALSE; // If set to "1", switch to fail safe demand when anlaog low is detected  
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_analogMinDemandEnable = FALSE;// If "True", min demand is maintaned when volts is below minVolts and above onVolts
  
  analog_4_20ma_Control_ptr.analog_4_20mA_Setting.inputMode_u8 = ANALOG_MODE;    // 0 = Analog input; 1 = digital input; 
...
void InitAnalogAmpsInputParameters(void) // Init local parameters and metering data
{
  ...
  analog_4_20ma_Control_ptr.analog_4_20mA_Data.increasingIntercept_u16 = 0;      // Intercept used to calculate demand when analog is increasing
  analog_4_20ma_Control_ptr.analog_4_20mA_Data.decreasingIntercept_u16 = 0;      // Intercept used to calcualte demand when analog is decreasing
  
  analog_amps_low_alarm_enable_count_u8 = analog_4_20ma_Control_ptr.analog_4_20mA_Setting.analogLowAlarmEnableCount_u8;
  ...
  analog_4_20ma_Control_ptr.analog_4_20mA_Data.increasingIntercept_u16 = (float)(analog_4_20ma_Control_ptr.analog_4_20mA_Setting.minDemand_u16 - (float)((analog_4_20ma_Control_ptr.analog_4_20mA_Data.increasingSlope_f) * (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.minVolts_u16))); // Interecept used to calculate demand when analog is increasing
  
  analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_analogLow = FALSE;             // Set to "TRUE", if analog low is detected
  analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_decreasingAnalog = FALSE;       // Set to "TRUE", if analog voltage is decresing
  analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_lowerHysteresisEnable = FALSE;  // Set to "TRUE", if lower end hys is enabled
  analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_upperHysteresisEnable = FALSE;  // Set to "TRUE", if upper end hys is enabled 
  analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_demandOn = FALSE;               // Set to"TRUE", if demand goes from 0 to above min_Demand_u16.
...
void DebounceAnalogAmps(void){
  ...
  {  // Change is analog is above debounce
    ...
    { // Analog is decreasing
      analog_amps_decreasing_debounce_count_u8++;
      analog_amps_increasing_debounce_count_u8 = 0;
    ...
    { // Analog is increasing
      analog_amps_increasing_debounce_count_u8++;
      analog_amps_decreasing_debounce_count_u8 = 0;
    } 
    
    // Check debounce loop count
    if ( (analog_amps_increasing_debounce_count_u8 > analog_4_20ma_Control_ptr.analog_4_20mA_Setting.debounceLoopCount_u8) || (analog_amps_decreasing_debounce_count_u8 > analog_4_20ma_Control_ptr.analog_4_20mA_Setting.debounceLoopCount_u8)  )
    {
      ...
      if(analog_amps_decreasing_debounce_count_u8 > analog_4_20ma_Control_ptr.analog_4_20mA_Setting.debounceLoopCount_u8) 
      {
        analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_decreasingAnalog = TRUE;
      } else
      {
        analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_decreasingAnalog = FALSE;
      }
      analog_amps_decreasing_debounce_count_u8 = 0;
      analog_amps_increasing_debounce_count_u8 = 0;
    }
    ...
    {
      analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_digitalInputON = FALSE;
    } else{
      analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_digitalInputON = TRUE;
    }
    ...
    { // Check if analog volts is low
      ...
      {
        analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_analogLow = TRUE;
      } else {
        analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_analogLow = FALSE;
      }
    } else{
...
uint16_t GetAnalogAmpsDemand(void){
  ...
  if (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.inputMode_u8 != ANALOG_MODE)
  {
    analog_demand_u32 = 0;
    analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_demandOn = FALSE;
  } else if( (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_analogLowEnable == TRUE) && (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_analogFailSafeEnable == TRUE ) && (analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_analogLow == TRUE)) { 
    // Check if Loss of analog
    if((analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_demandOn == FALSE) && (is_amps_above_loss_analog == FALSE))//demand is never gone above min demand. 
    {  // Analog never crossed turned ON volts
      ...
      analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_demandOn = TRUE;
      analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_upperHysteresisEnable = FALSE;
    }
  } else {
    // If invert is enabled invert measured value
    if (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_invertAnalog == TRUE) 
    {
    ...
    if (analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_decreasingAnalog == FALSE)
    { // Slope used when analog value is increasing
      slope_f = analog_4_20ma_Control_ptr.analog_4_20mA_Data.increasingSlope_f;
      intercept_u16 = analog_4_20ma_Control_ptr.analog_4_20mA_Data.increasingIntercept_u16;
    } else {
      // Slope used when analog value is decreasing
      slope_f = analog_4_20ma_Control_ptr.analog_4_20mA_Data.decreasingSlope_f;
      intercept_u16 = analog_4_20ma_Control_ptr.analog_4_20mA_Data.decreasingIntercept_u16;
    }
    ...
    if ((analog_volts_u16 >= analog_4_20ma_Control_ptr.analog_4_20mA_Setting.offVolts_u16) && (analog_volts_u16 < (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.maxVolts_u16 - analog_4_20ma_Control_ptr.analog_4_20mA_Setting.voltsHysteresis_u16)))
    {
      ...
      if (analog_volts_u16 >= analog_4_20ma_Control_ptr.analog_4_20mA_Setting.onVolts_u16) {
        ...
        {          
          ...
          analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_lowerHysteresisEnable = TRUE;
          ...
          if((analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_analogMinDemandEnable) == TRUE && ( analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_lowerHysteresisEnable == TRUE)){
          ...
          } else if( (analog_volts_u16 >= (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.minVolts_u16 - analog_4_20ma_Control_ptr.analog_4_20mA_Setting.minDemandHysteresis_u16)) && ( analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_lowerHysteresisEnable == TRUE)){
            // Apply lower end hysteresis
            analog_demand_u32 = (uint32_t)((uint64_t)(slope_f * analog_volts_u16) + intercept_u16);
          } else{
            if ((analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_invertAnalog == TRUE) && (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.is_analogMinDemandEnable == TRUE))
            {
              analog_demand_u32 = analog_4_20ma_Control_ptr.analog_4_20mA_Setting.minDemand_u16;
            } else{
    ...
    } else if (analog_volts_u16 >= (analog_4_20ma_Control_ptr.analog_4_20mA_Setting.maxVolts_u16 - analog_4_20ma_Control_ptr.analog_4_20mA_Setting.voltsHysteresis_u16)) {
      // Part 3: 
      // upperHysteresis till maxVolts
      
      // Analog voltage above upper hysteresis voltage      
      if (analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_upperHysteresisEnable  == TRUE)
      { // Analog already crossed hysteresis point
        if (analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_decreasingAnalog == TRUE)
        ...
        analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_upperHysteresisEnable  = TRUE;
        analog_demand_u32 = (uint32_t)((uint64_t)(slope_f * analog_volts_u16) + intercept_u16);
      } else if (analog_volts_u16 > analog_4_20ma_Control_ptr.analog_4_20mA_Setting.maxVolts_u16) {
    ...
    if (analog_demand_u32 < analog_4_20ma_Control_ptr.analog_4_20mA_Setting.minDemand_u16)
    {
      ...
      analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_demandOn = TRUE; // Demand greater than min demand.  
      analog_4_20ma_Control_ptr.analog_4_20mA_Data.is_lowerHysteresisEnable = TRUE; // Enable Hysteresis
    }
