...
#define ENABLE_WHOLEFRAME_USART2_BUF_FIXED_LEN 1 // Default was 1
  ...
  #define FIXED_WHOLEFRAME_USART2_MAX_LENGTH 100 // Inclusive (this value is accepted) 
  unsigned char fixedwholeFrameBuf_Usart2_Length = 0;
  unsigned char fixedwholeFrameBuf_Usart2[200];
