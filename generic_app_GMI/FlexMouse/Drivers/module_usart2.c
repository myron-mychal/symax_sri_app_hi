...
#define FIXED_RXCMD_USART2_MAX_LENGTH  USART2_TX_RX_BUF_SIZE // Inclusive (this value is accepted). REVIEW: Size, left high for flash reads 
...
void assign_UART2_ModuleMem(uint8_t drv_id_u8){  
  ...
  usart2InternalSeqMem_u32 = SeqMem_CreateInstance(MODULE_USART2, USART2_TX_RX_BUF_SIZE, ACCESS_MODE_WRITE_ONLY, NULL, EMPTY_LIST);
  //System call create a buffer for final packet receiver buffer 
  usart2SeqMemRX_transparentMode_u32 = SeqMem_CreateInstance(MODULE_USART2, USART2_TX_RX_BUF_SIZE, ACCESS_MODE_WRITE_ONLY, NULL, EMPTY_LIST);
  //System call create a buffer for final packet receiver buffer 
  usart2SeqMemRX_u32 = SeqMem_CreateInstance(MODULE_USART2, USART2_TX_RX_BUF_SIZE, ACCESS_MODE_WRITE_ONLY, NULL, EMPTY_LIST);
  //System call create a buffer for Tx data
  usart2SeqMemTX_u32 = SeqMem_CreateInstance(MODULE_USART2, USART2_TX_RX_BUF_SIZE, ACCESS_MODE_WRITE_ONLY, NULL, EMPTY_LIST);      
