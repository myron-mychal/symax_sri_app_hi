...
#define USART1_SINGLE_MESSAGE_RX_BUF_SIZE 32 // REVIEW: What size do we need for flash maps?
#define USART1_SINGLE_MESSAGE_TX_BUF_SIZE 32 // REVIEW: What size do we need for flash maps?
